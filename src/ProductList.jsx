        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <div>
                        <a href="#" onClick={(e) => handlePlantsClick(e)} className="navitem" style={styleA}>Plants</a>
                        <a href="#" onClick={(e) => handleAboutClick(e)} className="navitem" style={styleA}>About</a></div>
